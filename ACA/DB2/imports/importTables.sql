...
load from doc_class.del of del lobs from ./ modified by identityignore replace into doc_class;
load from doc_alias.del of del lobs from ./ modified by identityignore replace into doc_alias;
load from object_type.del of del lobs from ./ modified by identityignore replace into object_type;
load from key_class.del of del lobs from ./ modified by identityignore replace into key_class;
load from key_alias.del of del lobs from ./ modified by identityignore replace into key_alias;
load from attribute_alias.del of del lobs from ./ modified by identityignore replace into attribute_alias;
load from cword.del of del lobs from ./ modified by identityignore replace into cword;
load from heading.del of del lobs from ./ modified by identityignore replace into heading;
load from heading_alias.del of del lobs from ./ modified by identityignore replace into heading_alias;
load from user_detail.del of del lobs from ./ modified by identityignore replace into user_detail;
load from login_detail.del of del lobs from ./ modified by identityignore replace into login_detail;
load from integration.del of del lobs from ./ modified by identityignore replace into integration;
load from import_ontology.del of del lobs from ./ modified by identityignore replace into import_ontology;
load from api_integrations_objectsstore.del of del lobs from ./ modified by identityignore replace into api_integrations_objectsstore;
load from smartpages_options.del of del lobs from ./ modified by identityignore replace into smartpages_options;
load from fonts.del of del lobs from ./ modified by identityignore replace into fonts;
load from fonts_transid.del of del lobs from ./ modified by identityignore replace into fonts_transid;
load from key_spacing.del of del lobs from ./ modified by identityignore replace into key_spacing;
load from feature.del of del lobs from ./ modified by identityignore replace into feature;
load from training_log.del of del lobs from ./ modified by identityignore replace into training_log;
load from models.del of del lobs from ./ modified by identityignore replace into models;
load from published_models.del of del lobs from ./ modified by identityignore replace into published_models;
load from processed_file.del of del lobs from ./ modified by identityignore replace into processed_file;
load from error_log.del of del lobs from ./ modified by identityignore replace into error_log;
load from audit_ontology.del of del lobs from ./ modified by identityignore replace into audit_ontology;
load from audit_login_activity.del of del lobs from ./ modified by identityignore replace into audit_login_activity;
load from audit_processed_files.del of del lobs from ./ modified by identityignore replace into audit_processed_files;
load from audit_user_activity.del of del lobs from ./ modified by identityignore replace into audit_user_activity;
load from audit_api_activity.del of del lobs from ./ modified by identityignore replace into audit_api_activity;
load from audit_system_activity.del of del lobs from ./ modified by identityignore replace into audit_system_activity;
load from audit_integration_activity.del of del lobs from ./ modified by identityignore replace into audit_integration_activity;
load from implementation.del of del lobs from ./ modified by identityignore replace into implementation;
load from implementation_kc.del of del lobs from ./ modified by identityignore replace into implementation_kc;
load from systemt_models.del of del lobs from ./ modified by identityignore replace into systemt_models;
load from systemt_model_metadata.del of del lobs from ./ modified by identityignore replace into systemt_model_metadata;
load from runtime_doc.del of del lobs from ./ modified by identityignore replace into runtime_doc;
load from kvp_model_detail.del of del lobs from ./ modified by identityignore replace into kvp_model_detail;
load from runtime_page.del of del lobs from ./ modified by identityignore replace into runtime_page;
load from feedback.del of del lobs from ./ modified by identityignore replace into feedback;
