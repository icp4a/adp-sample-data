This repository stores IBM ADP sample data that needs to be loaded.  Please follow the instructions in the IBM Knowledge Center to load the data into the project databases.
